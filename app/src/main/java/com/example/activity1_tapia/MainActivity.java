package com.example.activity1_tapia;
...
import com.example.activity1_tapia.R;


public class MainActivity extends AppCompatActivity {

    Button button_red,button_blue,button_green,button_reset,button_yellow,button_violet;
        ...
        button_red.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button_red.getText().equals("RED"))
                {
                    ...
                    Toast.makeText(MainActivity.this,"You have succesfully change the color to red", Toast.LENGTH_LONG).show();
        ...
        button_blue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button_blue.getText().equals("BLUE"))
                {
                    ...
                    Toast.makeText(MainActivity.this,"You have succesfully change the color to blue", Toast.LENGTH_LONG).show();
        ...
        button_green.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button_green.getText().equals("GREEN"))
                {
                    ...
                    Toast.makeText(MainActivity.this,"You have succesfully change the color to green", Toast.LENGTH_LONG).show();
        ...
        button_yellow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    if(button_yellow.getText().equals("YELLOW"))
                {
                    ...
                    Toast.makeText(MainActivity.this,"You have succesfully change the color to yellow", Toast.LENGTH_LONG).show();
        ...
        button_violet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button_violet.getText().equals("VIOLET"))
                {
                    ...
                    Toast.makeText(MainActivity.this,"You have succesfully change the color to violet", Toast.LENGTH_LONG).show();
        ...
        button_reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(button_reset.getText().equals("RESET"))
                {
                    ...
                    Toast.makeText(MainActivity.this,"You have succesfully reset the color", Toast.LENGTH_LONG).show();
